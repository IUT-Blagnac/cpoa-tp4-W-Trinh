...
import action.ActionAccountDeposit;
import action.ActionAccountWithdraw;
import action.ActionList;
import bank.BankAgency;

public class ActionListAccountOperation implements ActionList{
	private String msg;
	private String code;
	private String title;
	private ArrayList<Action> actionList;
	
	public ActionListAccountOperation(String msg, String code, String title) {
		this.msg =  msg;
		this.code=  code;
		this.title= title;
		this.actionList = new ArrayList<Action>();
		actionList.add(new ActionAccountDeposit("1"));
		actionList.add(new ActionAccountWithdraw("2"));
	}
